		...
		<form action="review" method="post">
			...
			<div class="form-group">
				<label for="firstName">Name: </label> <input type="text"
					...
					value="${employee.firstName} ${employee.lastName}" readOnly="readonly">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="email">Email: </label> <input type="email"
					class="form-control" name="email" value="${employee.email}" readOnly="readonly">
			</div>
			<div class="form-group">
				<label for="leaveBalance">Leave Balance</label> <input type="text"
					class="form-control" name="leaveBalance"
			...
			<div class="form-group">
				<label for="leaveType">Leave Type: </label> <input type="text"
					class="form-control" name="leaveType" value="${leave.leaveType}" readOnly="readonly">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="status">Leave Status: </label> <input
					type="text" class="form-control" name="status"
					value="${leave.status}" readOnly="readonly">
			</div>
			<br>
			<h5>Fill below:</h5>
			<br>
