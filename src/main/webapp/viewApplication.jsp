					...
					<tr>
						...
						<c:choose>
							<c:when test="${status=='approved'}">
								<td><a
									href="download?leaveId=${leave.leaveId}&employeeId=${leave.employeeId}" data-toggle="tooltip" title="Download a pdf version of your approved leave!"><button
											class="btn btn-outline-success" type="button">Download</button></a></td>
							</c:when>

							<c:when test="${status=='declined'}">
								<td><a href="#" data-toggle="tooltip" title="The Leave application has been closed,no further action is Allowed!"><button class="btn btn-outline-danger"
											type="button">Closed</button></a></td>
							</c:when>
							<c:otherwise>
								<td><a
									href="edit?leaveId=${leave.leaveId}&employeeId=${leave.employeeId}" data-toggle="tooltip" title="Edit your application"><button
								...
								<td><a
									href="${deleteLink}" data-toggle="tooltip" title="Remove your application"><button
